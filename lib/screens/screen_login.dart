...
class EmailInput extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var login = Provider.of<LoginModel>(context, listen: false);//LoginModel을 가져옴.
...
class RegisterButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextButton(
        ...
        child: Text(
          '이메일로 회원가입하기',style: TextStyle(color: Colors.black)
        ));
  }
}//회원가입버튼 위젯
...
//   var url = Uri.parse('http://34.170.39.54:6000/login');
//   var data = {'id': id};
