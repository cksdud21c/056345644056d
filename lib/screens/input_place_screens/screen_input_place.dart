        ...
        child: Column(
          children: [
            DropdownButtonFormField<String>(
              ...
              items: ['성동구', '광진구', '동대문구', '중구', '종로구', '용산구', '서대문구', '마포구', '강서구', '양천구', '강동구', '송파구', '강남구', '서초구', '도봉구', '노원구', '은평구' ,'성북구', '관악구', '동작구', '금천구', '구로구', '영등포구'].map((district) {
...
// }
Future<List<List<String>>> sendPlaceNameValueToServer(String id, String pn, String d, String c) async {
    List<List<String>> recommendationSets = [['https://image.msscdn.net/images/goods_img/20230524/3321882/3321882_16850629457621_500.jpg',
      'https://image.msscdn.net/images/goods_img/20230524/3321882/3321882_16850629457621_500.jpg',
      'https://image.msscdn.net/images/goods_img/20230524/3321882/3321882_16850629457621_500.jpg',
      'https://image.msscdn.net/images/goods_img/20230524/3321882/3321882_16850629457621_500.jpg',
          'https://image.msscdn.net/images/goods_img/20230524/3321882/3321882_16850629457621_500.jpg'
    ],
